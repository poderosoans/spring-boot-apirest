...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter{
	...
	public JwtAccessTokenConverter accessTokenConverter() { // Trabaja con JWT para codificar y decodificar
		...
		jwtAccessTokenConverter.setSigningKey(JwtConfig.PRIVATE_RSA);	// Firmamos el token
		jwtAccessTokenConverter.setVerifierKey(JwtConfig.PUBLIC_RSA);	// Validar la autenticidad del token
